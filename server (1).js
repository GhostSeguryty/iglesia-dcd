...
function defaultSite() {
  return {
    ...
    heroVerseRef: 'Juan 3:16 (RVR 1960)',
    verses: [
      { text: 'Todo lo puedo en Cristo que me fortalece.', ref: 'Filipenses 4:13 (RVR 1960)' },
      { text: 'Porque yo sé los pensamientos que tengo acerca de vosotros, dice Jehová, pensamientos de paz, y no de mal, para daros el fin que esperáis.', ref: 'Jeremías 29:11 (RVR 1960)' },
      { text: 'Venid a mí todos los que estáis trabajados y cargados, y yo os haré descansar.', ref: 'Mateo 11:28 (RVR 1960)' },
      { text: 'Jehová es mi pastor; nada me faltará.', ref: 'Salmos 23:1 (RVR 1960)' }
    ],
    ...
    schedule: [
      ...
      { day: 'Sábado', time: '6:30 p.m.', title: 'Estudio general', place: 'Templo', note: 'Estudio para toda la familia.' },
    ...
    heroEyebrow: 'Iglesia en Durango',
    btnHorarios: 'Ver horarios',
    btnEventos: 'Próximos eventos',
    titleHorarios: 'Horarios de la semana',
    leadHorarios: 'Hay un espacio para cada edad y para toda la familia.',
    titleEventos: 'Próximos eventos',
    leadEventos: 'El pastor y el administrador pueden actualizar esta sección cuando quieran.',
    titleNosotros: 'Quiénes somos',
    labelPastor: 'Pastor',
    titleOracion: 'Peticiones de oración',
    leadOracion: 'Déjanos tu petición. El equipo pastoral la verá en el panel.',
    titleContacto: 'Contacto y ubicación'
  };
}
